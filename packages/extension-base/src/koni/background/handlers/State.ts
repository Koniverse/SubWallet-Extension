...
export default class KoniState {
  ...
  public async sleep () {
    ...
    await Promise.all([this.historyService.stop(), this.priceService.stop(), this.balanceService.stop(), this.nftServiceV2.stop(), this.earningService.stop(), this.swapService.stop(), this.inappNotificationService.stop(), this.openGovService.stop()]);
  ...
  private async _startFull () {
    ...
    await Promise.all([this.cron.start(), this.subscription.start(), this.historyService.start(), this.priceService.start(), this.balanceService.start(), this.nftServiceV2.start(), this.earningService.start(), this.swapService.start(), this.inappNotificationService.start(), this.openGovService.start()]);
