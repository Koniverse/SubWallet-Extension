...
export default class KoniExtension {
  ...
  private async makeTransfer (inputData: RequestSubmitTransfer): Promise<SWTransactionResponse> {
    ...
    return this.#koniState.transactionService.handleTransaction({
      ...
      multisigAccountInfo: this.#koniState.keyringService.context.getMultisigAccountInfoByAddress(inputData.signerSubstrateMultisigAddress)
    });
  }
  ...
  private async handleYieldLeave (params: RequestYieldLeave): Promise<SWTransactionResponse> {
    ...
    return await this.#koniState.transactionService.handleTransaction({
      ...
      multisigAccountInfo: this.#koniState.keyringService.context.getMultisigAccountInfoByAddress(params.signerSubstrateMultisigAddress)
    });
  }
  ...
  private async handleVote (request: GovVoteRequest): Promise<SWTransactionResponse> {
    ...
    return await this.#koniState.transactionService.handleTransaction({
      ...
      multisigAccountInfo: this.#koniState.keyringService.context.getMultisigAccountInfoByAddress(request.signerSubstrateMultisigAddress)
    });
  }
  ...
  public async handle<TMessageType extends MessageTypes> (id: string, type: TMessageType, request: RequestTypes[TMessageType], port: chrome.runtime.Port): Promise<ResponseType<TMessageType>> {
    ...
    switch (type) {
      ...
      case 'pri(multisig.getSignableProxyIds)':
        return this.#koniState.keyringService.context.getSignableProxyIds(request as RequestGetSignableProxyIds);
        /* Multisig Account */
