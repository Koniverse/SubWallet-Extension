...
import {
  isAvailBridgeGatewayContract,
  isSnowBridgeGatewayContract
...
import {
  createAvailBridgeExtrinsicFromAvail, createAvailBridgeExtrinsicFromEvm,
    ...
    if (fromKeyPair && destinationTokenInfo) {
      if (isSnowBridgeEvmTransfer) {
        ...
        if (isAvailBridgeFromEvm) {
          ...
          extrinsic = await createAvailBridgeExtrinsicFromEvm({
            destinationTokenInfo,
            originTokenInfo,
            sendingValue: value,
            sender: from,
