...
export default class KoniExtension {
  ...
  private async getHistoryCurrentTokenPrice (priceId: string): Promise<HistoryCurrentTokenPrice> {
    return this.#koniState.priceService.getHistoryCurrentPrice(priceId);
  }
