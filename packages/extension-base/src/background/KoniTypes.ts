...
import { ApprovePendingTxRequest, CancelPendingTxRequest, ExecutePendingTxRequest, InitMultisigTxRequest, InitMultisigTxResponse, PrepareMultisigSignRequest, RequestGetSignableAccountInfos, ResponseGetSignableAccountInfos } from '@subwallet/extension-base/types/multisig';
...
export interface KoniRequestSignatures {
  ...
  'pri(multisig.prepareSignRequest)': [PrepareMultisigSignRequest, boolean];
  /* Multisig Account */
