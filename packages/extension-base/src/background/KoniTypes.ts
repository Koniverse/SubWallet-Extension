...
import { ApprovePendingTxRequest, CancelPendingTxRequest, ExecutePendingTxRequest, InitMultisigTxRequest, InitMultisigTxResponse, InitSubstrateProxyTxRequest, RequestGetSignableAccountInfos, ResponseGetSignableAccountInfos } from '@subwallet/extension-base/types/multisig';
...
export interface KoniRequestSignatures {
  ...
  'pri(substrateProxyAccount.initProxyTx)': [InitSubstrateProxyTxRequest, SWTransactionResponse];
}
