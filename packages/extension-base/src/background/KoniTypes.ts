...
import { ApprovePendingTxRequest, CancelPendingTxRequest, ExecutePendingTxRequest, RequestGetSignableAccountInfos, RequestPrepareMultisigTransaction, ResponseGetSignableAccountInfos, ResponsePrepareMultisigTransaction } from '@subwallet/extension-base/types/multisig';
...
export interface KoniRequestSignatures {
  ...
  'pri(multisig.prepareMultisigTransaction)': [RequestPrepareMultisigTransaction, ResponsePrepareMultisigTransaction];
  /* Multisig Account */
