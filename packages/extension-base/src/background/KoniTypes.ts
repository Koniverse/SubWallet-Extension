...
import { ApprovePendingTxRequest, CancelPendingTxRequest, ExecutePendingTxRequest, RequestGetSignableProxies, ResponseGetSignableProxies } from '@subwallet/extension-base/types/multisig';
...
export interface KoniRequestSignatures {
  ...
  'pri(multisig.getSignableProxies)': [RequestGetSignableProxies, ResponseGetSignableProxies];
  /* Multisig Account */
