...
// export const isEvmTransaction = (tx: SWTransaction['transaction']): tx is TransactionConfig => {
//   return !!(tx as TransactionConfig).nonce;
// };

export const isTonTransaction = (tx: SWTransaction['transaction']): tx is TonTransactionConfig => {
  return !!(tx as TonTransactionConfig).messages;
};
