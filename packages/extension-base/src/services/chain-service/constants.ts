...
export const _BALANCE_CHAIN_GROUP = {
  ...
  statemine: ['statemine', 'astar', 'shiden', 'statemint', 'crabParachain', 'darwinia2', 'parallel', 'calamari', 'manta_network', 'rococo_assethub', 'liberlandTest', 'liberland', 'dentnet', 'pangolin', 'crust', 'phala', 'shibuya', 'dbcchain', 'westend_assethub', 'chainflip_assethub', 'paseo_assethub', 'origintrail', 'energy_web_x'],
...
export const _KNOWN_CHAIN_INFLATION_PARAMS: Record<string, _SubstrateInflationParams> = {
  ...
  statemine: { ..._SUBSTRATE_DEFAULT_INFLATION_PARAMS, auctionAdjust: (0.3 / 60), auctionMax: 60, stakeTarget: 0.75 }, // todo: recheck
  ...
  statemint: { ..._SUBSTRATE_DEFAULT_INFLATION_PARAMS, stakeTarget: 0.75 }, // todo: recheck
...
export const _TRANSFER_CHAIN_GROUP = {
  ...
  statemine: ['statemint', 'statemine', 'darwinia2', 'astar', 'shiden', 'shibuya', 'parallel', 'liberland', 'liberlandTest', 'dentnet', 'dbcchain', 'westend_assethub', 'chainflip_assethub', 'paseo_assethub', 'origintrail', 'energy_web_x'],
  riochain: ['riochain'],
