...
import { LogContext, LogLevel, LoggerConfig, StructuredLogData } from './types';
...
export class Logger {
  ...
  constructor (config: LoggerConfig) {
    ...
    this.config = {
      ...
      enableContextCapture: config.enableContextCapture ?? true
    };
  ...
  // Group methods (console.group/groupEnd replacement)
