...
import { ADD_SUBSTRATE_PROXY_TRANSACTION, CANCEL_UN_STAKE_TRANSACTION, CHANGE_VALIDATOR_TRANSACTION, CLAIM_BRIDGE_TRANSACTION, CLAIM_REWARD_TRANSACTION, CURRENT_PAGE, EARN_TRANSACTION, NFT_TRANSACTION, REMOVE_SUBSTRATE_PROXY_TRANSACTION, STAKE_TRANSACTION, SWAP_TRANSACTION, TRANSFER_TRANSACTION, UN_STAKE_TRANSACTION, WITHDRAW_TRANSACTION } from '@subwallet/extension-koni-ui/constants';
...
export const detectTransactionPersistKey = (type?: ExtrinsicType): string => {
  switch (type) {
    ...
    case ExtrinsicType.ADD_SUBSTRATE_PROXY:
      return ADD_SUBSTRATE_PROXY_TRANSACTION;
    case ExtrinsicType.REMOVE_SUBSTRATE_PROXY:
      return REMOVE_SUBSTRATE_PROXY_TRANSACTION;
    default:
      return '';
  }
};
