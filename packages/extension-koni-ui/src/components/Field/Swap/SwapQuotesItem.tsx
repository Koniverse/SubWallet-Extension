        ...
        <div className={'__right-part'}>
          ...
          <div className={'__line-2 __line'}>
            <div className='__line-label'>
              <span className={'__est-receive-label'}>{t('ui.Swap.QuotesItem.estReceive')}</span>
            </div>
          ...
          <div className={'__line-3 __line'}>
            <div className='__line-label'>{t('ui.Swap.QuotesItem.fee')}</div>
            <div className='__line-value'>
              <NumberDisplay
                decimal={0}
                metadata={swapNumberMetadata}
          ...
          <div className={'__line-4 __line hidden'}>
            <div className='__line-label'>{t('ui.Swap.QuotesItem.process')}</div>
            <div className='__line-value'>
