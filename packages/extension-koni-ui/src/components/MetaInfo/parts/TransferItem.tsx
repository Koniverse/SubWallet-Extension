    ...
    return (
      <>
        <AccountItem
          ...
          label={senderLabel || t('ui.MetaInfo.TransferItem.sender')}
          name={senderName}
        />
        ...
        {!!originChain && !!destinationChain && originChain.slug === destinationChain.slug
          ? (
            <ChainItem
              ...
              label={t('ui.MetaInfo.TransferItem.network')}
            />
          )
          : (
            <>
              {!!originChain && (
                <ChainItem
                  chain={originChain.slug}
                  label={t('ui.MetaInfo.TransferItem.originChain')}
                />
              )}
              ...
              {!!destinationChain && (
                <ChainItem
                  ...
                  label={t('ui.MetaInfo.TransferItem.destinationChain')}
                />
              )}
            </>
          )}
  ...
  return (
    <div className={CN(className, '__row -type-transfer')}>
      <div className={'__col __label-col'}>
        <div className={'__label'}>{senderLabel || t('ui.MetaInfo.TransferItem.sender')}</div>
      ...
      <div className={'__col __value-col'}>
        <div className={'__label'}>{recipientLabel || t('ui.MetaInfo.TransferItem.recipient')}</div>
