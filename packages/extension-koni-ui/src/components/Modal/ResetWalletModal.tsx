...
const Component: React.FC<Props> = (props: Props) => {
  ...
  return (
    <SwModal
      ...
      id={modalId}
      onCancel={onClose}
      title={t('ui.Modal.ResetWallet.forgotPassword')}
    >
      <div className='container'>
        ...
        <div className='description'>
          {t('ui.Modal.ResetWallet.passwordNotStoredResetInfo')}
        </div>
        <div className='footer-area'>
          <Button
            ...
            schema='secondary'
          >
            {t('ui.Modal.ResetWallet.resetAccount')}
          </Button>
          <Button
            block={true}
            className='footer-button'
            ...
            schema='danger'
          >
            {t('ui.Modal.ResetWallet.eraseAll')}
          </Button>
        </div>
      </div>
    </SwModal>
