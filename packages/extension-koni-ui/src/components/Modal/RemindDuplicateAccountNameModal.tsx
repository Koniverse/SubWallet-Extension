    ...
    return (
      <>
        <Button
          ...
          onClick={onCancel}
        >
          {t('ui.Modal.RemindDuplicateAccountName.iUnderstand')}
        </Button>
      </>
    );
  }, [onCancel, t]);
  ...
  return (
    <>
      <SwModal
        ...
        maskClosable={false}
        onCancel={onCancel}
        title={t('ui.Modal.RemindDuplicateAccountName.duplicateAccountName')}
      >
        <div className={'__modal-content'}>
          ...
          <div className='__modal-description'>
            {t('ui.Modal.RemindDuplicateAccountName.duplicateAccountNameInfo')}
            <a
