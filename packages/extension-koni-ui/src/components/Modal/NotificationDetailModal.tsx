...
function Component (props: Props): React.ReactElement<Props> {
  ...
  return (
    <SwModal
      ...
      onCancel={_onCancel}
      title={t('ui.Modal.NotificationDetail.actions')}
    >
      <div className={'__button-container'}>
        ...
        >
          ...
          <div className={'__right-part'}>{readNotification ? t('ui.Modal.NotificationDetail.markAsUnread') : t('ui.Modal.NotificationDetail.markAsRead')}</div>
        </div>
      </div>
