    ...
    <>
      <SwModal
        ...
        footer={(
          ...
          >
            {t('ui.Modal.Common.RecheckChainConnection.update')}
          </Button>
        )}
        id={modalId}
        onCancel={onCancel}
        title={t('ui.Modal.Common.RecheckChainConnection.updateNetwork')}
      >
        <div className={'__message'}>
          {t('ui.Modal.Common.RecheckChainConnection.selectedNetworkConnectionLost')}
        </div>
      </SwModal>
    </>
  );
