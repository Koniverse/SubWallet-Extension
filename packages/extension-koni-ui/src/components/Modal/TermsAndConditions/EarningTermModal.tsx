...
import { EARNING_TERM_AND_CONDITION_MODAL } from '@subwallet/extension-koni-ui/constants';
...
const Component = ({ className, onOk }: Props) => {
  ...
  return (
    <SwModal
      ...
      closable={false}
      id={modalId}
      title={t('ui.TERM.components.Modal.Terms.Earning.earningPolicy')}
    >
      <div
        className={'term-body'}
      ...
      <div className={'term-footer'}>
        ...
        >{t('ui.TERM.components.Modal.Terms.Earning.agreeToEarningPolicy')}</Checkbox>
        <div className={'term-footer-button-group'}>
          <Button
            ...
            onClick={onConfirm}
          >
            {t('ui.TERM.components.Modal.Terms.Earning.continue')}
          </Button>
          <span className={'term-footer-annotation'}>{t('ui.TERM.components.Modal.Terms.Earning.scrollToReadAll')}</span>
        </div>
      </div>
    </SwModal>
  );
