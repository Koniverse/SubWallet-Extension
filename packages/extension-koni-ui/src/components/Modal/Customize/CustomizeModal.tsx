...
function Component ({ className = '' }: Props): React.ReactElement<Props> {
  ...
  return (
    <SwModal
      ...
      id={CUSTOMIZE_MODAL}
      onCancel={onCancel}
      title={t('ui.Modal.Customize.Modal.customizeAssetDisplay')}
    >
      <div className={'__group-label'}>{t('ui.Modal.Customize.Modal.balance')}</div>
      <div className={'__group-content'}>
        <SettingItem
          ...
          name={t('ui.Modal.Customize.Modal.showZeroBalance')}
          rightItem={
            <Switch
      ...
      <div className={'__group-label'}>{t('ui.Modal.Customize.Modal.networks')}</div>
