...
function Component (props: Props): React.ReactElement<Props> {
  ...
  const title = useMemo(() => {
    ...
    switch (label) {
      case 'dApp':
        return t('ui.Modal.Earning.ValidatorDetail.dAppDetails');
      case 'Collator':
        return t('ui.Modal.Earning.ValidatorDetail.collatorDetails');
      case 'Validator':
        return t('ui.Modal.Earning.ValidatorDetail.validatorDetails');
    }
  }, [t, chain]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.Modal.Earning.ValidatorDetail.minimumStakeRequired')}
          suffix={symbol}
          value={minStake}
...

        {
          totalStake !== '0' && <MetaInfo.Number
            decimals={decimals}
            label={t('ui.Modal.Earning.ValidatorDetail.totalStake')}
            suffix={symbol}
            value={totalStake}
            valueColorSchema={'even-odd'}
          />
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.Modal.Earning.ValidatorDetail.ownStake')}
          suffix={symbol}
          value={ownStake}
          valueColorSchema={'even-odd'}
        />

        {
          otherStake !== '0' && <MetaInfo.Number
            decimals={decimals}
            label={t('ui.Modal.Earning.ValidatorDetail.stakeFromOthers')}
            suffix={symbol}
            value={otherStake}
            valueColorSchema={'even-odd'}
          />
...

        {
          earningEstimated > 0 && earningEstimated !== '' && <MetaInfo.Number
            label={t('ui.Modal.Earning.ValidatorDetail.estimatedApy')}
            suffix={'%'}
        ...
        <MetaInfo.Number
          label={t('ui.Modal.Earning.ValidatorDetail.commission')}
          suffix={'%'}
          value={commission}
          valueColorSchema={'even-odd'}
        />
