    ...
    <div className={CN(className)}>
      ...
      >
        ...
        <MetaInfo.AccountGroup
          ...
          content={t('ui.Modal.TxProcessDetail.InfoBlock.Earn.Bond.numberSelectedValidator', { replace: { number: data.selectedValidators.length, validatorLabel: handleValidatorLabel.toLowerCase() } })}
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.Modal.TxProcessDetail.InfoBlock.Earn.Bond.amount')}
          suffix={symbol}
          value={data.amount}
        />
