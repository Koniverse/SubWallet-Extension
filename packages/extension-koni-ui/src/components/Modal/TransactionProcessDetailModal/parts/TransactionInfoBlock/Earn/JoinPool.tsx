    ...
    <div className={CN(className)}>
      ...
      >
        ...
        <MetaInfo.Account
          ...
          label={t('ui.Modal.TxProcessDetail.InfoBlock.Earn.JoinPool.pool')}
          networkPrefix={42}
        />
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.Modal.TxProcessDetail.InfoBlock.Earn.JoinPool.amount')}
          suffix={symbol}
          value={data.amount}
        />
        ...
        <MetaInfo.Number
          decimals={0}
          label={t('ui.Modal.TxProcessDetail.InfoBlock.Earn.JoinPool.estimatedFee')}
