          ...
          <div className='__item-actions'>
            {
              showDeriveButton && (
                <Button
                  ...
                  size='xs'
                  tooltip={t('ui.AccountProxy.SelectorItem.deriveThisAccount')}
                  type='ghost'
                />
              )
            }
            <Button
              ...
              size='xs'
              tooltip={t('ui.AccountProxy.SelectorItem.copyAddress')}
              type='ghost'
            />
            <Button
              icon={
              ...
              size='xs'
              tooltip={t('ui.AccountProxy.SelectorItem.viewDetails')}
              type='ghost'
            />
          </div>
