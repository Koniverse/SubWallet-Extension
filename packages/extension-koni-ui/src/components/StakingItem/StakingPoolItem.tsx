      ...
      middleItem={
        <div className={'middle-item'}>
          ...
          <div className={'middle-item__bond-amount'}>
            <span className={'middle-item__bond-amount-label'}>{t('ui.StakingItem.Pool.staked')}</span>
            <Number
            ...
            <span className={CN('middle-item__pool-earning-status', { not: !isProfitable })}>
              ...
              <span>
                {isProfitable ? t('ui.StakingItem.Pool.earning') : t('ui.StakingItem.Pool.notEarning')}
              </span>
            </span>
          </div>
        </div>
