...
function Component ({ activeNominators,
  ...
  return (
    <SwModal
      ...
      title={t('ui.NetworkInformation.networkDetails')}
    >
      <MetaInfo
      ...
      >
        {
          stakingType === StakingType.NOMINATED && (
            <>
              <MetaInfo.Number
                label={t('ui.NetworkInformation.maxNomination')}
...

              {
                !!activeNominators &&
                (
                  <MetaInfo.Default label={t('ui.NetworkInformation.totalNominators')}>
        ...
        {!!estimatedEarning && !!inflation &&
          <MetaInfo.Default
            label={t('ui.NetworkInformation.estimatedEarnings')}
            labelAlign={'top'}
          >
            <div className={'__active-nominators-value'}>
              <Number
              ...
              />
              <span className={'__inflation'}>{t('ui.NetworkInformation.afterInflation')}</span>
            </div>
          </MetaInfo.Default>
        }
        ...
        <MetaInfo.Number
          ...
          label={t('ui.NetworkInformation.minimumActive')}
          suffix={minimumActive.symbol}
          value={minimumActive.value}
          valueColorSchema={'success'}
        />

        {!!unstakingPeriod && <MetaInfo.Default label={t('ui.NetworkInformation.unstakingPeriod')}>
