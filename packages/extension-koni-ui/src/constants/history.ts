...
export const TxTypeNameMap: Record<ExtrinsicType, string> = {
  ...
  [ExtrinsicType.ADD_SUBSTRATE_PROXY]: detectTranslate('ui.HISTORY.constant.history.addSubstrateProxy'),
  [ExtrinsicType.REMOVE_SUBSTRATE_PROXY]: detectTranslate('ui.HISTORY.constant.history.removeSubstrateProxy'),
