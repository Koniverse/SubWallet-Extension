...
export const ADD_PROXY_TRANSACTION = 'transaction.add-proxy';
export const REMOVE_PROXY_TRANSACTION = 'transaction.remove-proxy';

export const TRANSACTION_STORAGES = [TRANSFER_TRANSACTION, NFT_TRANSACTION, EARN_TRANSACTION, UN_STAKE_TRANSACTION, CANCEL_UN_STAKE_TRANSACTION, WITHDRAW_TRANSACTION, CLAIM_REWARD_TRANSACTION, SWAP_TRANSACTION, CHANGE_VALIDATOR_TRANSACTION, ADD_PROXY_TRANSACTION, REMOVE_PROXY_TRANSACTION];
