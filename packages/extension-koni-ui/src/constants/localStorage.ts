...
export const ADD_SUBSTRATE_PROXY_TRANSACTION = 'transaction.add-substrate-proxy';
export const REMOVE_SUBSTRATE_PROXY_TRANSACTION = 'transaction.remove-substrate-proxy';

export const TRANSACTION_STORAGES = [TRANSFER_TRANSACTION, NFT_TRANSACTION, EARN_TRANSACTION, UN_STAKE_TRANSACTION, CANCEL_UN_STAKE_TRANSACTION, WITHDRAW_TRANSACTION, CLAIM_REWARD_TRANSACTION, SWAP_TRANSACTION, CHANGE_VALIDATOR_TRANSACTION, ADD_SUBSTRATE_PROXY_TRANSACTION, REMOVE_SUBSTRATE_PROXY_TRANSACTION];
