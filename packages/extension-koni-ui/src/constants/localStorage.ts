...
export const ADD_SUBSTRATE_PROXY_ACCOUNT_TRANSACTION = 'transaction.add-substrate-proxy';
export const REMOVE_SUBSTRATE_PROXY_ACCOUNT_TRANSACTION = 'transaction.remove-substrate-proxy';
