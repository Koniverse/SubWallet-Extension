...
const Component: React.FC<Props> = ({ className }: Props) => {
  ...
  const passwordRules = useMemo(() => renderBasePasswordRules(t('ui.Keyring.CreatePassword.password'), t), [t]);
  ...
  const checkBoxValidator = useCallback((rule: RuleObject, value: boolean): Promise<void> => {
    if (!value) {
      return Promise.reject(new Error(t('ui.Keyring.CreatePassword.checkboxIsRequired')));
    }
  ...
  return (
    <PageWrapper className={CN(className)}>
      <Layout.WithSubHeaderOnly
        rightFooterButton={{
          children: t('ui.Keyring.CreatePassword.continue'),
          onClick: form.submit,
          loading: loading,
          disabled: isDisabled,
          icon: FooterIcon
        ...
        title={t('ui.Keyring.CreatePassword.createAPassword')}
      >
        <div className='body-container'>
          <div className='notify'>
            {t('ui.Keyring.CreatePassword.passwordForThisBrowserOnly')}
          </div>
          <Form
            form={form}
            initialValues={{
          ...
          >
            ...
            >
              <Input.Password
                ...
                placeholder={t('ui.Keyring.CreatePassword.enterPassword')}
                type='password'
              />
            </Form.Item>
            <Form.Item
            ...
            >
              <Input.Password
                placeholder={t('ui.Keyring.CreatePassword.confirmPassword')}
                type='password'
              />
            </Form.Item>
            <Form.Item>
              <div className={'annotation'}>
                {t('ui.Keyring.CreatePassword.passwordRequirements')}
              </div>
            </Form.Item>
            <Form.Item
          ...
          <SwModal
            ...
            title={t('ui.Keyring.CreatePassword.instructions')}
            wrapClassName={className}
          >
            <div className='instruction-container'>
              <AlertBox
                description={t('ui.Keyring.CreatePassword.walletAutoLockInfo')}
                title={t('ui.Keyring.CreatePassword.whyNeedPassword')}
              />
              <AlertBox
                description={t('ui.Keyring.CreatePassword.passwordNotRecoverable')}
                title={t('ui.Keyring.CreatePassword.canRecoverPassword')}
              />
            </div>
          </SwModal>
        </div>
