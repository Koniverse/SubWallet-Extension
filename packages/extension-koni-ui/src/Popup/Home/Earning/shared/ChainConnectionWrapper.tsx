...
import { AlertModal, ConnectChainModal, LoadingModal } from '@subwallet/extension-koni-ui/components';
...
export const ChainConnectionWrapper = ({ alertModalId,
  ...
  return (
    <>
      ...
      <LoadingModal
        loadingText={t('ui.Earning.shared.ChainConnectionWrapper.gettingData')}
