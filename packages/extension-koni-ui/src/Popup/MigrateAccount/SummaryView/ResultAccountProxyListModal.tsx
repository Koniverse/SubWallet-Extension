      ...
      footer={(
        <>
          <Button
            ...
            onClick={onClose}
          >
            {t('ui.ACCOUNT.screen.MigrateAccount.SummaryView.ResultProxyListModal.close')}
          </Button>
        </>
      )}
      id={resultAccountProxyListModal}
      onCancel={onClose}
      title={t('ui.ACCOUNT.screen.MigrateAccount.SummaryView.ResultProxyListModal.migratedAccountList')}
      zIndex={9999}
    >
      {
