      ...
      footer={(
        <>
          <Button
            ...
            schema={'secondary'}
          >
            {t('ui.MigrateAccount.EnterPasswordModal.cancel')}
          </Button>
          <Button
            block={true}
            disabled={loading}
            ...
            onClick={form.submit}
          >
            {t('ui.MigrateAccount.EnterPasswordModal.continue')}
          </Button>
        </>
      )}
      id={enterPasswordModalId}
      title={t('ui.MigrateAccount.EnterPasswordModal.enterPassword')}
      zIndex={9999}
    >
      <div className='__brief'>
        {t('ui.MigrateAccount.EnterPasswordModal.enterSubWalletPasswordToContinue')}
      </div>
      ...
      >
        <Form.Item
          ...
          rules={[
            {
              message: t('ui.MigrateAccount.EnterPasswordModal.passwordIsRequired'),
              required: true
            }
          ]}
        ...
        >
          <Input.Password
            ...
            id={passwordInputId}
            label={t('ui.MigrateAccount.EnterPasswordModal.password')}
            placeholder={t('ui.MigrateAccount.EnterPasswordModal.enterPassword')}
            suffix={<span />}
          />
        </Form.Item>
      </Form>
