...
function Component (props: Props): React.ReactElement<Props> {
  ...
  const timeline = useMemo<string>(() => {
    if (!data.start_time && !data.end_time) {
      return t('ui.Settings.MissionPool.Item.tbd');
    }

    const start = data.start_time ? customFormatDate(new Date(data.start_time), '#DD# #MMM# #YYYY#') : t('ui.Settings.MissionPool.Item.tbd');
    const end = data.end_time ? customFormatDate(new Date(data.end_time), '#DD# #MMM# #YYYY#') : t('ui.Settings.MissionPool.Item.tbd');
      ...
      <div className={'__item-inner'}>
        ...
        <div className={'__right-block'}>
          ...
          <div className={'__item-rewards'}>
            <div className='__item-label'>{t('ui.Settings.MissionPool.Item.rewards')}:&nbsp;</div>
