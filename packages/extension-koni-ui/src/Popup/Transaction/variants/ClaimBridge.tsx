    ...
    <>
      <TransactionContent>
        ...
        >
          ...
          <FreeBalance
            ...
            label={t('ui.Transaction.ClaimBridge.availableBalance')}
          ...
          <Form.Item>
            ...
            >
              <MetaInfo.Chain
                chain={chainValue}
                label={t('ui.Transaction.ClaimBridge.network')}
              />
              {
                metadata && (
                  <MetaInfo.Number
                    decimals={decimals}
                    label={t('ui.Transaction.ClaimBridge.amount')}
                    suffix={symbol}
                    value={ amountValue }
                  />
                )
      ...
      <TransactionFooter>
        <Button
          ...
          schema={'secondary'}
        >
          {t('ui.Transaction.ClaimBridge.cancel')}
        </Button>
        ...
        >
          {t('ui.Transaction.ClaimBridge.continue')}
        </Button>
      </TransactionFooter>
    </>
  );
