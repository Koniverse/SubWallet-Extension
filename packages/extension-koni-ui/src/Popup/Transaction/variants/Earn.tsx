        ...
        content:
          (<>
            <div className={'earning-alert-content'}>
              {t('ui.Transaction.Earn.dualStakingFreezeWarning', { replace: { symbol: symbol, originChain: originChain } })}
            </div>
          </>),
      ...
      timeout = setTimeout(() => {
        ...
        if (!isConnectingChainSuccess) {
          ...
          openAlert({
            ...
            type: NotificationType.ERROR,
            content: altChain
              ? t('ui.Transaction.Earn.dualNetworkConnectionLost', { replace: { poolChainName: poolChainName, altChainName: altChainName } })
              : t('ui.Transaction.Earn.networkConnectionLost', { replace: { poolChainName: poolChainName } }),
            okButton: {
              text: t('ui.Transaction.Earn.iUnderstand'),
              onClick: closeAlert,
              icon: CheckCircle
