...
import { findAccountByAddress, formatBalance, getAssetDisplay, getSignModeByAccountProxy, noop, SortableTokenItem, sortTokensByBalanceInSelector } from '@subwallet/extension-koni-ui/utils';
      ...
      Object.values(assetRegistry).forEach((chainAsset) => {
        ...
        if (!sendFundSlug || (chainAsset.slug === sendFundSlug || _getMultiChainAsset(chainAsset) === sendFundSlug)) {
          result.push({
            ...
            displaySymbol: getAssetDisplay(chainAsset, chainAsset.symbol),
            originChain
          });
        }
      });
