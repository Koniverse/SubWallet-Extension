...
const Component = (props: Props) => {
  ...
  if (!address) {
    return (
      ...
      >
        {t('ui.TRANSACTION.screen.Transaction.part.FreeBalanceToEarn.selectAccountToViewBalance')}
    ...
    >
      {!error && (
        ...
        >
          ...
          >
            {label || t('ui.TRANSACTION.screen.Transaction.part.FreeBalanceToEarn.senderAvailableBalance')}
