  ...
  return (
    <PageWrapper className={CN(className)}>
      <Layout.WithSubHeaderOnly
        onBack={goHome}
        rightFooterButton={{
          children: t('ui.Account.ExportAllDone.finish'),
          icon: FinishIcon,
          onClick: goHome
        }}
        subHeaderIcons={[
        ...
        title={t('ui.Account.ExportAllDone.successful')}
      >
        <div className='body-container'>
          <div className={CN('notice')}>
            <AlertBox
              description={t('ui.Account.ExportAllDone.privateKeyWarning')}
              title={t('ui.Account.ExportAllDone.warningNeverDiscloseKey')}
              type='warning'
            />
          </div>
          <div className='result-content'>
            ...
            <div className='json-done-tile'>
              {t('ui.Account.ExportAllDone.success')}
            </div>
            <div className='json-done-description'>
              {t('ui.Account.ExportAllDone.successfullyExportedJsonForAccounts')}
            </div>
          </div>
        </div>
      </Layout.WithSubHeaderOnly>
