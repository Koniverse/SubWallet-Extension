...
const Component: React.FC<ThemeProps> = () => {
  ...
  return (
    <ConnectQrSigner
      deviceName={t('ui.Account.ConnectQrSigner.Keystone.keystone')}
      ...
      subTitle={t('ui.Account.ConnectQrSigner.Keystone.keystoneSoftwareWalletInstruction')}
      title={t('ui.Account.ConnectQrSigner.Keystone.connectKeystoneDevice')}
    />
  );
};
