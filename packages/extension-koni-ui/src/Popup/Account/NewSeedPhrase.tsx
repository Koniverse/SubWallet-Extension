  ...
  return (
    ...
    >
      <Layout.WithSubHeaderOnly
        ...
        rightFooterButton={{
          children: t('ui.Account.NewSeedPhrase.keptItSomewhereSafe'),
          icon: FooterIcon,
        ...
        title={t('ui.Account.NewSeedPhrase.yourSeedPhrase')}
      >
        <div className={'container'}>
          <div className='description'>
            {t('ui.Account.NewSeedPhrase.seedPhraseSecurityWarning')}
          </div>
          <WordPhrase
            enableDownload={true}
