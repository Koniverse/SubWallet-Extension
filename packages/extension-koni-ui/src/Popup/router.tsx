...
const NewMultisigAccount = new LazyLoader('NewMultisigAccount', () => import('@subwallet/extension-koni-ui/Popup/Account/NewMultisigAccount'));
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          NewMultisigAccount.generateRouterObject('new-multisig-account'),
