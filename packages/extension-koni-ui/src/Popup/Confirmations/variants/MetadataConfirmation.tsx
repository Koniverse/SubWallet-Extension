    ...
    <>
      <div className={CN('confirmation-content', className)}>
        ...
        <div className={'account-list text-center'}>
          ...
          <Typography.Paragraph className={'text-left'}>
            <span className='__prop-label text-tertiary text-right'>{t('ui.Confirmations.Metadata.decimal')}</span> <span>{tokenDecimals}</span>
          </Typography.Paragraph>
          <Typography.Paragraph className={'text-left'}>
            <span className='__prop-label text-tertiary text-right'>{t('ui.Confirmations.Metadata.specVersion')}</span> <span>{specVersion}</span>
          </Typography.Paragraph>
        </div>
      </div>
      <div className='confirmation-footer'>
        <Button
          ...
          schema={'secondary'}
        >
          {t('ui.Confirmations.Metadata.cancel')}
        </Button>
        <Button
          icon={(
            <Icon
          ...
          onClick={onConfirm}
        >
          {t('ui.Confirmations.Metadata.approve')}
        </Button>
      </div>
    </>
  );
