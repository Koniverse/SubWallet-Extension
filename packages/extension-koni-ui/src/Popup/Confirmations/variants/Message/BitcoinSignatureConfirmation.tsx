  ...
  return (
    <>
      <div className={CN('confirmation-content', className)}>
        ...
        <div className='title'>
          {t('ui.Confirmations.Message.BitcoinSignature.signatureRequired')}
        </div>
        <div className='description'>
          {t('ui.Confirmations.Message.BitcoinSignature.approvingRequestWithAccount')}
        </div>
        ...
        {(!errors || errors.length === 0) && <div>
          <Button
            ...
            type='ghost'
          >
            {t('ui.Confirmations.Message.BitcoinSignature.viewDetails')}
          </Button>
        </div>
        }
      </div>
      ...
      {(!errors || errors.length === 0) && <BaseDetailModal
        title={t('ui.Confirmations.Message.BitcoinSignature.messageDetails')}
      >
        <MetaInfo.Data>
