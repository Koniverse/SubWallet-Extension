    ...
    <div className={CN(className)}>
      ...
      >
        <MetaInfo.Number
          ...
          label={t('ui.Confirmations.Transaction.Process.Earn.JoinYieldPool.amount')}
        ...
        {!!derivativeTokenBasicInfo && (
          <MetaInfo.Number
            ...
            label={t('ui.Confirmations.Transaction.Process.Earn.JoinYieldPool.estimatedReceivables')}
        ...
        <MetaInfo.Number
          ...
          label={t('ui.Confirmations.Transaction.Process.Earn.JoinYieldPool.estimatedFee')}
