    ...
    <div className={CN(className)}>
      ...
      >
        ...
        <MetaInfo.Number
          ...
          decimals={0}
          label={t('ui.TRANSACTION.Confirmations.Process.Swap.estimatedFee')}
        ...
        {!showQuoteExpired && getWaitingTime > 0 && <AlertBox
          ...
          description={t('ui.TRANSACTION.Confirmations.Process.Swap.swapProviderWaitingTime', { replace: { provider: data.provider.name, getWaitingTime: getWaitingTime } })}
      ...
      {isKyberSwap && (
        <AlertBox
          className={'__swap-quote-expired'}
          description={t('ui.TRANSACTION.Confirmations.Process.Swap.marketConditionsWarning')}
          title={t('ui.TRANSACTION.Confirmations.Process.Swap.payAttentionExclamation')}
          type='warning'
        />
      )}
