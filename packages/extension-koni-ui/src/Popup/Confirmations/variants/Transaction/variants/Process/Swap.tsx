    ...
    <div className={CN(className)}>
      ...
      >
        <MetaInfo.Account
          ...
          label={t('ui.Confirmations.Transaction.Process.Swap.recipient')}
          name={recipient?.name}
          networkPrefix={networkPrefix}
        />
        <MetaInfo.Default
          className={'__quote-rate-confirm'}
          label={t('ui.Confirmations.Transaction.Process.Swap.quoteRate')}
        ...
        {!showQuoteExpired && getWaitingTime > 0 && <AlertBox
          ...
          description={t('ui.Confirmations.Transaction.Process.Swap.swapProviderWaitingTime', { replace: { provider: data.provider.name, getWaitingTime: getWaitingTime } })}
          title={t('ui.Confirmations.Transaction.Process.Swap.payAttentionExclamation')}
          type='warning'
        />}
      ...
      {isKyberSwap && (
        <AlertBox
          className={'__swap-quote-expired'}
          description={t('ui.Confirmations.Transaction.Process.Swap.marketConditionsWarning')}
          title={t('ui.Confirmations.Transaction.Process.Swap.payAttentionExclamation')}
          type='warning'
        />
      )}
      ...
      {showQuoteExpired &&
        (
          <AlertBox
            className={'__swap-quote-expired'}
            description={t('ui.Confirmations.Transaction.Process.Swap.swapQuoteExpired')}
            title={t('ui.Confirmations.Transaction.Process.Swap.payAttentionExclamation')}
            type='warning'
          />)
      }
