    ...
    <div className={CN(className)}>
      <MetaInfo hasBackgroundWrapper>
        <MetaInfo.Account
          ...
          label={t('ui.Confirmations.Transaction.SendNft.sendFrom')}
          networkPrefix={networkPrefix}
        />

        <MetaInfo.Account
          address={data.recipientAddress}
          label={t('ui.Confirmations.Transaction.SendNft.sendTo')}
          networkPrefix={networkPrefix}
        />

        <MetaInfo.Chain
          chain={transaction.chain}
          label={t('ui.Confirmations.Transaction.SendNft.network')}
        />
      </MetaInfo>
      <MetaInfo hasBackgroundWrapper={true}>
        {
          !!(data.nftItemName || data.nftItem) && (
            <MetaInfo.Default label={t('ui.Confirmations.Transaction.SendNft.nft')}>
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.Confirmations.Transaction.SendNft.estimatedFee')}
          suffix={symbol}
