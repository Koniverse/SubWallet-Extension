...
export async function changeBittensorRootClaimType (data: RequestChangeBittensorRootClaimType) {
  return sendMessage('pri(yield.changeBittensorRootClaimType.submit)', data);
}
