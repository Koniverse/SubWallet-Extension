...
const useGetExcludedTokens = () => {
  ...
  // Memoize asset list so Object.values() is not called on every callback invocation
  const chainAssetList = useMemo(() => Object.values(assetRegistry), [assetRegistry]);
  ...
  return useCallback((chainList: string[], accountProxy?: AccountProxy): string[] => {
    ...
    return [];
  }, [accountProxies, chainAssetList, chainInfoMap, currentAccountProxy]);
};
