...
import { AccountChainAddressesModal, AccountProxySelectorItem, GeneralEmptyList } from '@subwallet/extension-web-ui/components';
import { ACCOUNT_CHAIN_ADDRESSES_MODAL } from '@subwallet/extension-web-ui/constants';
  ...
  return (
    <div className={className}>
      <SwList.Section
        ...
        searchPlaceholder={t<string>('ui.ACCOUNT.screen.Account.Detail.DerivedList.enterAccountNameOrAddress')}
      />
