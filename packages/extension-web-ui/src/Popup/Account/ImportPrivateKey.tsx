...
import { CloseIcon, HiddenInput, Layout, PageWrapper, PrivateKeyInput } from '@subwallet/extension-web-ui/components';
...
import { useAutoNavigateToCreatePassword, useCompleteCreateAccount, useDefaultNavigate, useFocusFormItem, useGoBackFromCreateAccount, useTranslation, useUnlockChecker } from '@subwallet/extension-web-ui/hooks';
import { createAccountSuriV2, validateAccountName, validateMetamaskPrivateKeyV2 } from '@subwallet/extension-web-ui/messaging';
        ...
        <div className={'container'}>
          <div className='import-container'>
            <div className='description'>
              {t('ui.IMPORT_PRIVATE_KEY.Popup.Account.ImportPrivateKey.toImportAnExistingWalletPleaseEnterThePrivateKeyHere')}
            </div>
            <Form
