...
import { AccountSelector, HiddenInput, MetaInfo, PageWrapper } from '@subwallet/extension-web-ui/components';
import { useGetChainAssetInfo, useGetChainPrefixBySlug, useHandleSubmitTransaction, useInitValidateTransaction, usePreCheckAction, useRestoreTransaction, useSelector, useTransactionContext, useWatchTransaction } from '@subwallet/extension-web-ui/hooks';
import { submitClaimAvailBridge, submitClaimPolygonBridge } from '@subwallet/extension-web-ui/messaging/transaction/bridge';
import { getInappNotification } from '@subwallet/extension-web-ui/messaging/transaction/notification';
import { ClaimBridgeParams, FormCallbacks, FormFieldData, ThemeProps } from '@subwallet/extension-web-ui/types';
