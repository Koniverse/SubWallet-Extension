...
import { BackgroundExpandView, Layout } from '@subwallet/extension-web-ui/components';
import { useDefaultNavigate, useTranslation } from '@subwallet/extension-web-ui/hooks';
import { passPhishingPage } from '@subwallet/extension-web-ui/messaging';
    ...
    >
      ...
      <div className='phishing-detection-message'>
        ...
        <Typography.Link
          ...
          size='lg'
        >
          {t('ui.PHISHING_DETECTED.Popup.PhishingDetected.viewFullList')}
        </Typography.Link>
      </div>
      <div
