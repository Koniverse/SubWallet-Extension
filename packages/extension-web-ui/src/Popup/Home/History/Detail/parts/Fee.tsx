...
import { isTypeTransfer } from '@subwallet/extension-web-ui/utils';
...
const Component: React.FC<Props> = (props: Props) => {
    ...
    return (
      <>
        <MetaInfo.Number
          ...
          label={t('ui.FEE.Popup.Home.History.Detail.parts.Fee.originChainFee')}
  ...
  return (
    <MetaInfo.Number
      decimals={fee?.decimals || undefined}
      label={t('ui.FEE.Popup.Home.History.Detail.parts.Fee.networkFee')}
      suffix={fee?.symbol || undefined}
      value={fee?.value || '0'}
    />
  );
