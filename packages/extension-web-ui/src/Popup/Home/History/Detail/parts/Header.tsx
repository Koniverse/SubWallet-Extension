...
import { isTypeStaking, isTypeTransfer } from '@subwallet/extension-web-ui/utils';
  ...
  if (isStaking) {
    return (
      <>
        <MetaInfo.Chain
          chain={data.chain}
          label={t('ui.HEADER.Popup.Home.History.Detail.parts.Header.network')}
        />
        <MetaInfo.Account
          address={data.from}
          label={t('ui.HEADER.Popup.Home.History.Detail.parts.Header.fromAccount')}
          name={data.fromName}
