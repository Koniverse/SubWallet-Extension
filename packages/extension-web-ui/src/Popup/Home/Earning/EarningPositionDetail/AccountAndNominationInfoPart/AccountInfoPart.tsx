...
import { EarningBittensorClaimRewardTypeModal, EarningNominationModal } from '@subwallet/extension-web-ui/components/Modal/Earning';
...
import { createEarningTypeTags, findAccountByAddress, getTransactionFromAccountProxyValue, isAccountAll, toShort } from '@subwallet/extension-web-ui/utils';
import { Button, Icon, ModalContext } from '@subwallet/react-ui';
import BigN from 'bignumber.js';
import CN from 'classnames';
import { ArrowSquareOut, CaretLeft, CaretRight, PencilSimpleLine } from 'phosphor-react';
...
function Component ({ className, compound, inputAsset, list, poolInfo }: Props) {
  ...
  }, [list, isSubnetStaking, t, inputAsset, isSpecial, deriveAsset?.decimals, deriveAsset?.symbol, isAllAccount, poolInfo.chain, renderAccount, earningTagType.color, earningTagType.label, openEarningBittensorClaimRewardTypeModal, haveNomination, haveValidator, canChangeValidator, createOpenValidator, createOpenNomination]);
