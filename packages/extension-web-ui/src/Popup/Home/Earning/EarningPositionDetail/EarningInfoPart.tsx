...
function Component ({ className, inputAsset, poolInfo }: Props) {
  ...
  return (
    <CollapsiblePanel
      ...
      title={t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.earningInfo')}
    >
      <MetaInfo
      ...
      >
        {!isSubnetStaking
          ? (
            <MetaInfo.Chain
              ...
              label={t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.network')}
            />
          )
          : (
            <MetaInfo.Default
              label={t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.subnet')}
            >
        ...
        {totalApy !== undefined && (
          <MetaInfo.Number
            label={t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.estimatedEarnings')}
            suffix={'% ' + t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.perYear')}
            value={totalApy}
        ...
        <MetaInfo.Number
          ...
          label={t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.minimumStaked')}
          suffix={inputAsset?.symbol}
          value={poolInfo.statistic?.earningThreshold.join || '0'}
          valueColorSchema='even-odd'
        />
        {unstakePeriod !== undefined && (
          <MetaInfo.Default label={t('ui.EARNING_INFO_PART.Popup.Home.Earning.EarningPositionDetail.EarningInfoPart.unstakingPeriod')}>
