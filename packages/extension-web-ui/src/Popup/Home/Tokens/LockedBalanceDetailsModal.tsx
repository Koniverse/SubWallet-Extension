...
import { BaseModal, NumberDisplay } from '@subwallet/extension-web-ui/components';
...
function Component ({ className = '', currentTokenInfo, id, lockedDetails, onCancel }: Props): React.ReactElement<Props> {
  ...
  }, [assetRegistry, currentTokenInfo.slug]);
  ...
  ], [democracy, governance, others, reserved, staking, t]);
