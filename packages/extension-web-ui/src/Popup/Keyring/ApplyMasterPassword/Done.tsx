...
const Component: React.FC<Props> = (props: Props) => {
  ...
  return (
    <div className={CN(className)}>
      ...
      <div className='title'>
        {t('ui.DONE.Popup.Keyring.ApplyMasterPassword.Done.allDone')}
      </div>
      <div className='description'>
        {t('ui.DONE.Popup.Keyring.ApplyMasterPassword.Done.youHaveSuccessfullyUpdatedMasterPasswordToAllAccounts')}
      </div>
          ...
          (
            <div className='and-more'>
              <Trans
                ...
                i18nKey={detectTranslate('ui.DONE.Popup.Keyring.ApplyMasterPassword.Done.andOtherHighlightHighlightAccounts')}
