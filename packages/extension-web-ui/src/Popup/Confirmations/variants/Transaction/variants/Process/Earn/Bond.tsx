...
import { useGetChainPrefixBySlug, useGetTransactionProcessSteps } from '@subwallet/extension-web-ui/hooks';
  ...
  return (
    <div className={CN(className)}>
      ...
      >
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.BOND.Popup.Confirmations.variants.Transaction.variants.Process.Earn.Bond.amount')}
          suffix={symbol}
          value={data.amount}
        />
        ...
        <MetaInfo.Number
          decimals={decimals}
          label={t('ui.BOND.Popup.Confirmations.variants.Transaction.variants.Process.Earn.Bond.estimatedFee')}
          suffix={symbol}
