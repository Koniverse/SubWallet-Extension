...
import { useGetTransactionProcessSteps, useSelector } from '@subwallet/extension-web-ui/hooks';
    ...
    <div className={CN(className)}>
      ...
      >
        <MetaInfo.Number
          ...
          label={t('ui.JOIN_YIELD_POOL.Popup.Confirmations.variants.Transaction.variants.Process.Earn.JoinYieldPool.amount')}
        ...
        {!!derivativeTokenBasicInfo && (
          <MetaInfo.Number
            ...
            label={t('ui.JOIN_YIELD_POOL.Popup.Confirmations.variants.Transaction.variants.Process.Earn.JoinYieldPool.estimatedReceivables')}
        ...
        <MetaInfo.Number
          ...
          label={t('ui.JOIN_YIELD_POOL.Popup.Confirmations.variants.Transaction.variants.Process.Earn.JoinYieldPool.estimatedFee')}
