...
import { useGetChainAssetInfo, useGetNativeTokenBasicInfo, useTranslation } from '@subwallet/extension-web-ui/hooks';
      ...
      >
        {
          claimToken && (
            <MetaInfo.Number
              ...
              label={t('ui.CLAIM_BRIDGE.Popup.Confirmations.variants.Transaction.variants.ClaimBridge.amount')}
        ...
        <MetaInfo.Number
          ...
          label={t('ui.CLAIM_BRIDGE.Popup.Confirmations.variants.Transaction.variants.ClaimBridge.estimatedFee')}
