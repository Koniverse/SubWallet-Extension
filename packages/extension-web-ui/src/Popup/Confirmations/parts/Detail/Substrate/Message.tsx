...
const Component: React.FC<Props> = (props: Props) => {
  ...
  return (
    <MetaInfo className={CN(className)}>
      <MetaInfo.Data label={t('ui.MESSAGE.Popup.Confirmations.parts.Detail.Substrate.Message.rawData')}>
        {bytes}
      </MetaInfo.Data>
      <MetaInfo.Data label={t('ui.MESSAGE.Popup.Confirmations.parts.Detail.Substrate.Message.message')}>
        {message}
      </MetaInfo.Data>
    </MetaInfo>
  );
