...
import { CONFIRMATION_QR_MODAL, CONFIRMATION_SCAN_MODAL } from '@subwallet/extension-web-ui/constants/modal';
      ...
      >
        ...
        <div className={'__button-wrapper'}>
          <Button
            ...
            onClick={onScan}
          >
            {t('ui.DAPP.Confirmations.Qr.DisplayPayloadModal.scanQr')}
          </Button>
        </div>
      </BaseModal>
    );
