...
import { AccountProxyItem, BaseModal } from '@subwallet/extension-web-ui/components';
import BackIcon from '@subwallet/extension-web-ui/components/Icon/BackIcon';
import { CREATE_ACCOUNT_MODAL, DERIVE_ACCOUNT_LIST_MODAL } from '@subwallet/extension-web-ui/constants';
import { WalletModalContext } from '@subwallet/extension-web-ui/contexts/WalletModalContextProvider';
import { useSwitchModal, useTranslation } from '@subwallet/extension-web-ui/hooks';
import { RootState } from '@subwallet/extension-web-ui/stores';
import { ThemeProps } from '@subwallet/extension-web-ui/types';
import { searchAccountProxyFunction } from '@subwallet/extension-web-ui/utils';
  ...
  return (
    <>
      <BaseModal
        ...
        maskClosable={true}
        onCancel={onBack}
        title={t('ui.DERIVE_ACCOUNT_LIST_MODAL.components.Modal.Account.DeriveAccountListModal.selectAccount')}
      >
        <SwList.Section
          displayRow={true}
          ...
          searchPlaceholder={t<string>('ui.DERIVE_ACCOUNT_LIST_MODAL.components.Modal.Account.DeriveAccountListModal.accountName')}
        />
      </BaseModal>
    </>
  );
