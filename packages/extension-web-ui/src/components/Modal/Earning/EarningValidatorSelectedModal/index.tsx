...
import { BaseModal, StakingNominationItem, StakingValidatorItem } from '@subwallet/extension-web-ui/components';
...
import { CHANGE_VALIDATOR_TRANSACTION, DEFAULT_CHANGE_VALIDATOR_PARAMS, VALIDATOR_DETAIL_MODAL } from '@subwallet/extension-web-ui/constants';
import { useFetchChainState, useGetPoolTargetList, useSelector, useSelectValidators } from '@subwallet/extension-web-ui/hooks';
...
import { ChangeValidatorParams, ThemeProps, ValidatorDataType } from '@subwallet/extension-web-ui/types';
import { getTransactionFromAccountProxyValue, reformatAddress } from '@subwallet/extension-web-ui/utils';
import { getValidatorKey } from '@subwallet/extension-web-ui/utils/transaction/stake';
import { Button, Icon, ModalContext, SwList, useExcludeModal } from '@subwallet/react-ui';
