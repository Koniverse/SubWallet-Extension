...
import { PREDEFINED_WALLETS, SELECT_EXTENSION_MODAL } from '@subwallet/extension-web-ui/constants';
...
import { isAndroid, isFirefox, isIOS, isMobile, openInNewTab } from '@subwallet/extension-web-ui/utils';
