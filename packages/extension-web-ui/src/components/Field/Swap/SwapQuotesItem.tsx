...
import { NumberDisplay, TransactionProcessPreview } from '@subwallet/extension-web-ui/components';
        ...
        <div className={'__right-part'}>
            ...
            <span className={'__provider-name-wrapper'}>
              ...
              {isRecommend && (
                <div className='__best-tag'>
                  {t('ui.SWAP_QUOTES_ITEM.components.Field.Swap.SwapQuotesItem.best')}
                </div>
              )}
            </span>
          ...
          <div className={'__line-2 __line'}>
            <div className='__line-label'>
              <span className={'__est-receive-label'}>{t('ui.SWAP_QUOTES_ITEM.components.Field.Swap.SwapQuotesItem.estReceive')}</span>
            </div>
          ...
          <div className={'__line-3 __line'}>
            <div className='__line-label'>{t('ui.SWAP_QUOTES_ITEM.components.Field.Swap.SwapQuotesItem.fee')}</div>
            <div className='__line-value'>
              <NumberDisplay
                decimal={0}
                metadata={swapNumberMetadata}
          ...
          <div className={'__line-4 __line hidden'}>
            <div className='__line-label'>{t('ui.SWAP_QUOTES_ITEM.components.Field.Swap.SwapQuotesItem.process')}</div>
            <div className='__line-value'>
