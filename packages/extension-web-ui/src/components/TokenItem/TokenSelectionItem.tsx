...
const Component = (props: Props) => {
  ...
  const _onClickCopyBtnAsync = useCallback((e: React.SyntheticEvent) => {
    ...
    onPreCopy?.()
      .then(() => {
        notify({
          message: t('ui.TOKEN_SELECTION_ITEM.components.TokenItem.TokenSelectionItem.copiedToClipboard')
        });
          ...
          (
            <>
                ...
                onPreCopy
                  ? (
                    <Button
                      ...
                      size='xs'
                      tooltip={isWebUI ? t('ui.TOKEN_SELECTION_ITEM.components.TokenItem.TokenSelectionItem.copyAddress') : undefined}
                      type='ghost'
                    />
                  )
                  : (
              ...
              <Button
                ...
                size='xs'
                tooltip={isWebUI ? t('ui.TOKEN_SELECTION_ITEM.components.TokenItem.TokenSelectionItem.showQrCode') : undefined}
                type='ghost'
              />
            </>
          )
