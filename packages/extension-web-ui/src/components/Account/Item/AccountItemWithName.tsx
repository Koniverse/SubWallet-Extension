    ...
    <AccountItemBase
      ...
      middleItem={(
        <div className={CN('account-item-content-wrapper', `direction-${direction}`)}>
          <div className={'account-item-name'}>{isAll ? t('ui.ACCOUNT_ITEM_WITH_NAME.components.Account.Item.AccountItemWithName.allAccounts') : (accountName || toShort(address, addressPreLength, addressSufLength))}</div>
