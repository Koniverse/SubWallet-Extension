...
import { NetworkGroup } from '@subwallet/extension-web-ui/components/MetaInfo/parts';
          ...
          : (
            <>
              ...
              <div className='__steps-label'>
                {`${chains.length} ${t('ui.TRANSACTION.components.TransactionProcess.Preview.numberSteps')}`}
              </div>
            </>
          )
      }
