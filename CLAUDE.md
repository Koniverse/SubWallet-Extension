...
- Sprint: sprint-2026-W33 (2026-08-10 → 08-16) — **open**, 13 stories / 43 pts. 8 carried from W31 on GitHub-board evidence, plus 5 written in-window: US-13.18 (ParaSpell v2), US-12.22 (#5055, shipped 1.3.87) and 3 QC stories. W29/W30/W31 closed retroactively on 2026-08-10.
- Active Stories: US-4.21 · US-4.22 · US-4.23 (all three on #4451 Bitcoin-API, `review`) · US-5.10 (security findings) · US-10.11 (WalletConnect) · US-12.11 (Trusted Stake, `review`) · US-13.11 (XCM/ParaSpell) · US-13.18 (ParaSpell HTTP v2, `review`, PR #5053 unmerged) · US-20.4 (submit performance, `review`) · US-42.15 (#5054 dApp-logo QC, `ready`, unrun).
- **The 6 carried anchors have not moved** — all still OPEN on 2026-08-13 and every one last touched *before* the window opened (#4451, #4889, #4995, #4946, #4424, #4984). Those `review`/`in-progress` statuses are carried claims from the 2026-08-10 board read, not fresh evidence.
...
- Last Version: 1.3.87 (released 2026-08-12 from `master`, single issue #5055 — see [docs/notes/2026-08-13.md](docs/notes/2026-08-13.md))
