...
- Sprint: sprint-2026-W38 (2026-09-14 → 09-20) — **open**, **8 stories / 57 pts**: US-12.23 (review, **4th window**), US-10.21 (in-progress, first window scoped), and six tester-placed US-42.24 rows (1.3.78 done, 1.3.79 done, 1.3.80 in progress, parent + regression + verify carried from W37 by the tester's own commit). Table updated the day they arrived — first window told in time. W37 **closed 2026-09-14 at 8 of 12 stories, 77 of 103 pts** — every done story was tester QC, the one dev story carried.
...
- **The web-runner QC programme**: 20 sub-tasks — **14 done (116 pts), 4 in progress on W38 (29 pts), 2 in `backlog` with no sprint (10 pts)**: 1.3.84, 1.3.85. Tester-owned; **do not move these stories between sprints** — same boundary as the test reports and US-42.24.20.
