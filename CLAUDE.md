...
- **#2057 Mobile tracker: 14 of 19 items done** (re-read 2026-09-08; items 15 and 16 newly ticked). Open: 6, 9, 17, 18, 19 — **item 9 is the only P1 left on the tracker** (intermittent infinite loading), item 19 is the only item with no bug ID. Tracker lives in [docs/notes/2026-09-04.md](docs/notes/2026-09-04.md), tick-list format; the tester's own verification is US-42.24.20 and is not mirrored there.
