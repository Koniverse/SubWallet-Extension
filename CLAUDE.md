...
- **#2057 Mobile tracker: 4 of 10 items done.** Items 8 and 9 (Substrate NFTs not displayed; intermittent infinite loading) are **logged nowhere** — tracker text only. Tracker lives in [docs/notes/2026-09-04.md](docs/notes/2026-09-04.md), tick-list format; the tester's own verification is US-42.24.20 and is not mirrored there.
- **US-12.23 is in its third window unchanged.** PR #5065 open and approved, #5064 closed by hand, dropped from 1.3.89. Its 16/16 QC is 11 days old against a branch nobody builds. Merge or reschedule — leaving it open is the option that decays, and it has.
