...
- **#2057 Mobile web-runner tracker** lives in [docs/notes/2026-09-04.md](docs/notes/2026-09-04.md) — tick-list, dev-side fix status only; the tester's verification is US-42.24.20 and is not mirrored. **The tracker is two comments; read both.**
- **US-12.23 is in its third window unchanged.** PR #5065 open and approved, #5064 closed by hand, dropped from 1.3.89. Re-checked 2026-09-11: head still untouched since **2026-08-27**, so its 16/16 QC is now **15 days old** against a branch nobody builds. W37 closes 09-13. Merge or reschedule — leaving it open is the option that decays, and it has.
- **US-10.21 is live work W37 did not know about.** `in-progress` since 09-09, [PR #5076](https://github.com/Koniverse/SubWallet-Extension/pull/5076) open with review required since 09-09 — while the sprint file said `backlog, no sprint` for two days. Facts corrected in W37 on 09-11; **not added to the scope table** (two days before close, a planning call). Same shape as W36's under-report.
