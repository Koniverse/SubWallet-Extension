...
goal: "Reconstructed window — 1 story/stories shipped in release 1.1.68 (EPIC-19). Derived from the CHANGELOG, not planned."
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| US-19.1 | Wallet create/restore onboarding wrapper (backup reminder, T&C) | EPIC-19 | P1 | 3 | ✅ done | — | [link](stories/US-19.1-wallet-create-restore-onboarding-wrapper.md) |

**Releases in this window:** 1.1.68 · **Points (retroactive):** 3
