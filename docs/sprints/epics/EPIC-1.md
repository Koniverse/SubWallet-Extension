...
| [US-1.6](../stories/US-1.6-platform-operations-and-out-of-repo-tooling.md) | Platform operations & out-of-repo tooling | Hold the tracked platform work whose code lives outside this repository | ✅ done | — |
...
| [US-1.11](../stories/US-1.11-dependency-library-and-build-maintenance.md) | Dependency, library & build maintenance | Version bumps, polkadot-API/libs, cross-browser build | ✅ done | 1.3.73 |
