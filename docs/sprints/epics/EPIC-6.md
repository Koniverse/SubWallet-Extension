...
| [US-6.14](../stories/US-6.14-open-ui-improvements-recovered-from-uncategorized.md) | Open UI improvements (recovered) | Open UI work not yet delivered (rule 9) | 📋 backlog | — |
