...
| [US-12.23](../stories/US-12.23-bittensor-manual-claim-native-staking.md) | Manual claim for Bittensor native staking | Root (netuid 0) basket rewards need a user-triggered claim; subnet/alpha have nothing to claim. PR #5065, +198/−14, **no test**. Issue body still empty — ACs derived from the code (#5064) | 👀 review | — |
