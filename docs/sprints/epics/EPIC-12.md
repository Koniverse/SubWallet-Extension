...
products and additional-network staking (FR-123..FR-127).
...
| 5 | **Network expansion** | [US-12.14](../stories/US-12.14-staking-for-additional-networks-enjin-phala-xx.md) | Additional-network staking — planned (Enjin, Phala, xx, …); Mythos/Tanssi/Amplitude/Energy ship under FR-114 / US-12.1 |
| 6 | **Accuracy & load hardening** | [US-12.15](../stories/US-12.15-earning-reward-and-apy-accuracy-hardening.md), [US-12.16](../stories/US-12.16-earning-performance-and-cache-hardening.md) | Reward/APY-figure correctness (US-12.15) and earning-surface performance + cache freshness across many pools (US-12.16) |
...
- **Bittensor alpha-token *bridges*** — owned by [EPIC-13](EPIC-13.md) (FR-135). EPIC-12 stakes/earns alpha; moving alpha across chains is a bridge concern.
...
| FR-117 | [US-12.4](../stories/US-12.4-liquid-staking-acala-bifrost-parallel-stellaswap.md) | 📋 backlog |
| FR-118 | [US-12.5](../stories/US-12.5-dapp-staking-astar.md) | 📋 backlog |
| FR-119 | [US-12.6](../stories/US-12.6-bittensor-dtao-subnet-staking.md) | 📋 backlog |
| FR-120 | [US-12.7](../stories/US-12.7-lending-interlay.md) | 📋 backlog |
| FR-121 | [US-12.8](../stories/US-12.8-earning-path-simulation-and-step-tracking.md) | 📋 backlog |
| FR-122 | [US-12.9](../stories/US-12.9-xcm-deposit-routing-into-earning.md) | 📋 backlog |
| FR-123 | [US-12.10](../stories/US-12.10-bittensor-alpha-token-liquid-staking.md) | 📋 backlog |
| FR-124 | [US-12.11](../stories/US-12.11-alpha-index-auto-rebalancing-delegate-staking.md) | 📋 backlog |
| FR-125 | [US-12.12](../stories/US-12.12-trusted-stake-alpha-index.md) | 📋 backlog |
| FR-126 | [US-12.13](../stories/US-12.13-backprop-alpha-subnet-trading.md) | 📋 backlog |
| FR-127 | [US-12.14](../stories/US-12.14-staking-for-additional-networks-enjin-phala-xx.md) | 📋 backlog |
...
> are `✅ shipped` (retroactive stories), FR-124 is `📋 planned`, and
> FR-123 / FR-125 / FR-126 / FR-127 are `📋 planned` (forward). FR-127
> (additional-network staking — Enjin / Phala / xx,
> [US-12.14](../stories/US-12.14-staking-for-additional-networks-enjin-phala-xx.md))
...
> — the native-nomination handler tree — not under FR-127. `done` +
...
| AD-23 | Static-data caching for earning pool info / targets | [US-12.1](../stories/US-12.1-native-nomination-staking-relay-and-parachains.md), [US-12.8](../stories/US-12.8-earning-path-simulation-and-step-tracking.md), [US-12.16](../stories/US-12.16-earning-performance-and-cache-hardening.md) |
| AD-24 | Backend Services SDK for multi-chain data aggregation | [US-12.8](../stories/US-12.8-earning-path-simulation-and-step-tracking.md), [US-12.16](../stories/US-12.16-earning-performance-and-cache-hardening.md) |
...
| [US-12.4](../stories/US-12.4-liquid-staking-acala-bifrost-parallel-stellaswap.md) | Liquid staking (Acala/Bifrost/Parallel/StellaSwap) | Stake into LST protocols (Acala, Bifrost (+Bifrost-Manta), Parallel, StellaSwap stDOT) and receive a liquid derivative token | 📋 backlog | — |
| [US-12.5](../stories/US-12.5-dapp-staking-astar.md) | dApp staking (Astar) | Stake to dApps on Astar's dApp-staking program and claim rewards | 📋 backlog | — |
| [US-12.6](../stories/US-12.6-bittensor-dtao-subnet-staking.md) | Bittensor dTAO subnet staking | Stake TAO into a subnet via the native dTAO / alpha-token model | 📋 backlog | — |
| [US-12.7](../stories/US-12.7-lending-interlay.md) | Lending (Interlay) | Lend assets on Interlay to earn yield (distinct from liquid staking) | 📋 backlog | — |
| [US-12.8](../stories/US-12.8-earning-path-simulation-and-step-tracking.md) | Earning-path simulation & step tracking | Simulate a multi-step stake and track each step's status to completion | 📋 backlog | — |
| [US-12.9](../stories/US-12.9-xcm-deposit-routing-into-earning.md) | XCM deposit routing into earning | Route a cross-chain deposit so funds land on the chain where the yield lives | 📋 backlog | — |
...
| [US-12.11](../stories/US-12.11-alpha-index-auto-rebalancing-delegate-staking.md) | Alpha-index auto-rebalancing delegate-staking | Delegate-stake an auto-rebalancing alpha index strategy (planned) | 📋 backlog | — |
| [US-12.12](../stories/US-12.12-trusted-stake-alpha-index.md) | Trusted Stake (alpha index) | Stake into the Trusted Stake alpha-index integration (forward roadmap) | 📋 backlog | — |
| [US-12.13](../stories/US-12.13-backprop-alpha-subnet-trading.md) | Backprop (alpha subnet trading) | Integrate the Backprop alpha-subnet trading product (forward roadmap) | 📋 backlog | — |
...
> staking belongs to FR-114 / US-12.1, not this story). US-12.15 and US-12.16 are the epic's two hardening
> clusters and own no FR. US-12.15 defends reward/APY-figure **accuracy** at the
> AD-22 handler seam (issues #3527, #2708, #4135, #2975, #2755). US-12.16 defends
...
> issue and homes in US-12.16, not the accuracy story.
...
| [US-12.11](../stories/US-12.11-alpha-index-auto-rebalancing-delegate-staking.md) | Handler-backed alpha-index aggregate over per-subnet stakes + rebalancing engine; index/target-weight data via Services SDK (AD-24) | FR-124 |
| [US-12.12](../stories/US-12.12-trusted-stake-alpha-index.md) | Trusted Stake partner-curated alpha-index position (handler-backed) on the native Subtensor path | FR-125 |
| [US-12.13](../stories/US-12.13-backprop-alpha-subnet-trading.md) | Backprop partner alpha-subnet trading position (handler-backed enter/exit) on the native Subtensor path | FR-126 |
| [US-12.14](../stories/US-12.14-staking-for-additional-networks-enjin-phala-xx.md) | New per-network staking handler subclasses (Enjin / Phala / xx) on the existing native tree; targets from static cache (AD-23) | FR-127 |
| [US-12.15](../stories/US-12.15-earning-reward-and-apy-accuracy-hardening.md) | Reward/APY-figure accuracy verified at the `BasePoolHandler` seam (AD-22) across every pool type | — |
| [US-12.16](../stories/US-12.16-earning-performance-and-cache-hardening.md) | Earning read-path performance + cache freshness: static cache (AD-23), Services SDK / lightweight WsProvider (AD-24 / AD-07), removed-account invalidation | — |
...
**Branches not shown:** Pool staking ([US-12.2](../stories/US-12.2-nomination-pool-staking.md)) joins a `NominationPoolHandler` pool rather than nominating validators directly ([US-12.1](../stories/US-12.1-native-nomination-staking-relay-and-parachains.md)), lowering the minimum to participate. Liquid staking ([US-12.4](../stories/US-12.4-liquid-staking-acala-bifrost-parallel-stellaswap.md)) and Interlay lending ([US-12.7](../stories/US-12.7-lending-interlay.md)) submit protocol mint/redeem or supply/withdraw through the `BaseSpecialStakingPoolHandler` branch instead of a native pallet bond, and the redeem/withdraw side runs the same flow in reverse (LST unbonding queue, market-availability-gated withdraw). The Bittensor dTAO path ([US-12.6](../stories/US-12.6-bittensor-dtao-subnet-staking.md)) stakes TAO→alpha against a subnet validator on the native Subtensor path with a `swapStakeLimit` slippage guard, and the forward alpha products layer on top of it — liquid-alpha ([US-12.10](../stories/US-12.10-bittensor-alpha-token-liquid-staking.md)), the auto-rebalancing index ([US-12.11](../stories/US-12.11-alpha-index-auto-rebalancing-delegate-staking.md)), Trusted Stake ([US-12.12](../stories/US-12.12-trusted-stake-alpha-index.md)) and Backprop ([US-12.13](../stories/US-12.13-backprop-alpha-subnet-trading.md)). A multi-step path interrupted after the deposit but before the stake is resumed from the stake step rather than re-run from the start ([US-12.8](../stories/US-12.8-earning-path-simulation-and-step-tracking.md), [US-12.9](../stories/US-12.9-xcm-deposit-routing-into-earning.md)).
...
- **Bittensor uses the native Subtensor path (AD-15):** all dTAO / alpha staking goes through the native Substrate pallet (`swapStakeLimit` / subnet pallets), never the Subtensor-EVM bridge — required for subnet-staking and reward-claim semantics the EVM cannot express. Enforced by [US-12.6](../stories/US-12.6-bittensor-dtao-subnet-staking.md) and the forward alpha stories ([US-12.10](../stories/US-12.10-bittensor-alpha-token-liquid-staking.md)–[US-12.13](../stories/US-12.13-backprop-alpha-subnet-trading.md)).
...
- [ ] A user can delegate-stake an auto-rebalancing alpha index — [US-12.11](../stories/US-12.11-alpha-index-auto-rebalancing-delegate-staking.md) (planned)
- [ ] A user can stake into the Trusted Stake alpha index — [US-12.12](../stories/US-12.12-trusted-stake-alpha-index.md) (planned)
- [ ] A user can trade alpha subnets via Backprop — [US-12.13](../stories/US-12.13-backprop-alpha-subnet-trading.md) (planned)
- [ ] A user can stake on additional networks — Enjin, Phala, xx, … (planned) — [US-12.14](../stories/US-12.14-staking-for-additional-networks-enjin-phala-xx.md) (Mythos/Tanssi/Amplitude/Energy ship under FR-114 / US-12.1)
- [ ] Reward/APY figures stay accurate across every pool type (validator APY, claimable rewards, post-claim re-render, all-method coverage, earning preview) — [US-12.15](../stories/US-12.15-earning-reward-and-apy-accuracy-hardening.md)
- [ ] The earning surface stays fast, memory-bounded and cache-fresh across many pools (cached-first paint, static-cache reads, removed-account invalidation) — [US-12.16](../stories/US-12.16-earning-performance-and-cache-hardening.md)
