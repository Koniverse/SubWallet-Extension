...
| [US-34.21](../stories/US-34.21-webapp-effect-when-open-modal-select-token-select-accou.md) | ✅ done | [WebApp] Effect when open modal Select token, Select account in case Buy token | [#2211](https://github.com/Koniverse/SubWallet-Extension/issues/2211) | Thiendekaco | 1.1.36 |
