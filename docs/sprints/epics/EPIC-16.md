...
> **US-16.4 … US-16.10 carry no FR.** They hold the incremental work, fixes and chores that landed
...
| [#4175](https://github.com/Koniverse/SubWallet-Extension/issues/4175) | Support cold wallets | #1387, #1829, #831, #3857 | #1387 and #1829 in [US-16.3](../stories/US-16.3-additional-hardware-wallets.md); **#831 and #3857 are filed elsewhere** |
...
>
> **#4175's other two children are hardware work sitting in other areas' ledgers.**
> [#831](https://github.com/Koniverse/SubWallet-Extension/issues/831) — *"Integrate with AirGap Vault
> for QR signer"* — is in the dApp maintenance ledger, and
> [#3857](https://github.com/Koniverse/SubWallet-Extension/issues/3857) — *"Unable to send funds out
> of Polkadot Vault"* — is in the Transactions one. Both belong to this epic: AirGap Vault extends
> [US-16.2](../stories/US-16.2-qr-signing-keystone-and-polkadot-vault.md)'s QR path and #3857 is a
> Polkadot Vault defect. They are **not** moved here yet — those two ledgers are still unfolded, and
> reaching into them would leave their counts wrong. Route them to this epic when EPIC-30 and
> EPIC-28 fold.
...
- **Key never enters the extension ([NFR-14](../../PRD.md#non-functional-requirements), AD-04):** every device
  ...
  maintenance stories US-16.4 … US-16.10 assert coverage of their tracker issues, not behaviour.
