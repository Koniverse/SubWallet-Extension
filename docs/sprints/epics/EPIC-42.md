...
| [US-42.24.5](../stories/US-42.24.5-qc-web-runner-1-3-72.md) | Web-runner 1.3.72 — proxy accounts and chain-list v0.2.123, both written out from their real scope; 45 / 47 AC pass, AC-19 and AC-27 skipped, 6 bugs on the proxy screens | done |
...
| [US-42.24.7](../stories/US-42.24.7-qc-web-runner-1-3-74.md) | Web-runner 1.3.74 — multisig phase 1, written out from the QC checklist; 28 / 32 AC pass, 28 bugs | done |
...
| [US-42.24.11](../stories/US-42.24.11-qc-web-runner-1-3-78.md) | Web-runner 1.3.78 — XCM and bridge fees, disable all networks, alpha tokens on Subtensor EVM, Alpha transfer, TAO bridge, Bittensor swap, chain-list v0.2.127; the XCM and liquid staking halves written out from the QC checklists; all 39 AC pass | done |
| [US-42.24.12](../stories/US-42.24.12-qc-web-runner-1-3-79.md) | Web-runner 1.3.79 — Alpha price, ParaSpell v1, display fixes after the 1.3.78 merge, swap refactor; all 15 AC pass | done |
...
| [US-42.24.21](../stories/US-42.24.21-qc-web-runner-1-3-87.md) | Web-runner 1.3.87 — nominator unstaking eras (#5055); empty issue body, all 5 AC pass, no bugs | done |
| [US-42.24.22](../stories/US-42.24.22-qc-web-runner-1-3-88.md) | Web-runner 1.3.88 — ParaSpell API v2 (#5051) plus chain-list: PRDCTR, the TUSDT rename, and fifteen XCM routes removed; AC written out from the release note, 17 AC; 17 of 17 AC pass, no bugs | done |
| [US-42.24.23](../stories/US-42.24.23-qc-web-runner-1-3-89.md) | Web-runner 1.3.89 — repoint KAH↔PAH XCM refs (#5062), the P0; all 6 AC pass, no bugs — the route delivers both ways, so the build carries both halves of the fix | done |
| [US-42.24.24](../stories/US-42.24.24-qc-web-runner-1-3-90.md) | Web-runner 1.3.90 — sr25519 VRF signing (#5072) and Bittensor manual claim (#5064); 22 AC; 21 pass and AC-5 is skipped, the two-origin check now left open by three stories; two bugs found and both settled, BUG-42.24.24-01 fixed and verified, BUG-42.24.24-02 skipped as a test-device effect | done |
| [US-42.24.19](../stories/US-42.24.19-qc-web-runner-regression.md) | Web-runner 1.3.86 — full wallet regression, Android and iOS, fresh install and upgrade; round 1 logged 16 bugs, 13 now fixed, 1 closed no fix, 2 still open; round 2 runs a rewritten checklist of 82 lines per platform and has logged 6 more, all of them now fixed | in-progress |
| [US-42.24.20](../stories/US-42.24.20-qc-web-runner-verify-bugs.md) | Web-runner 1.3.86 — verify the bugs found during the update; 72 of 79 verified, 5 closed no fix, their AC rerun and passing | in-progress |
