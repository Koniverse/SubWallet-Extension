...
| [US-42.24.20](../stories/US-42.24.20-qc-web-runner-verify-bugs.md) | Web-runner 1.3.86 — verify the bugs found during the update; 54 of 71 verified, 2 closed no fix, their AC rerun and passing | in-progress |
...
| [US-42.26](../stories/US-42.26-qc-release-extension-v1-3-90.md) | Release gate for Extension v1.3.90 — sr25519 VRF signing (#5072) and Bittensor manual claim (#5064), four build stages; 14 AC; dev merge stage passes | in-progress |
