...
| [US-42.24.22](../stories/US-42.24.22-qc-web-runner-1-3-88.md) | Web-runner 1.3.88 — ParaSpell API v2 (#5051) plus chain-list: PRDCTR, the TUSDT rename, and fifteen XCM routes removed; AC written out from the release note, 17 AC; 4 of 17 AC pass | in-progress |
