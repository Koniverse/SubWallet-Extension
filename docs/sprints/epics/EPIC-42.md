...
| [US-42.24.24](../stories/US-42.24.24-qc-web-runner-1-3-90.md) | Web-runner 1.3.90 — sr25519 VRF signing (#5072) and Bittensor manual claim (#5064); 22 AC; the VRF half passes 8 of 9, the two-origin check skipped for the third story running; BUG-42.24.24-01 is fixed and AC-10 passes its rerun, so the claim half is unblocked with AC-11 to AC-22 still to run | in-progress |
...
| [US-42.24.20](../stories/US-42.24.20-qc-web-runner-verify-bugs.md) | Web-runner 1.3.86 — verify the bugs found during the update; 65 of 78 verified, 3 closed no fix, their AC rerun and passing | in-progress |
