...
| [US-42.24.7](../stories/US-42.24.7-qc-web-runner-1-3-74.md) | Web-runner 1.3.74 — multisig phase 1, written out from the QC checklist; 32 AC, 22 bugs | in-progress |
...
| [US-42.24.20](../stories/US-42.24.20-qc-web-runner-verify-bugs.md) | Web-runner 1.3.86 — verify the bugs found during the update; 4 of 47 verified, their AC rerun and passing | in-progress |
