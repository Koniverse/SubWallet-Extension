...
| [US-13.19](../stories/US-13.19-repoint-kah-pah-usdt-xcm-refs.md) | Repoint KAH↔PAH USDt XCM refs | The KAH-native USDt was offered a bridge route it cannot cross, leaving tokens locked on the destination chain. Fixed in two repos — chainlist data ([ChainList #709](https://github.com/Koniverse/SubWallet-ChainList/pull/709)) plus a guard. **AC-6 (regression test) never written** (#5062) | ✅ done | 1.3.89 |
