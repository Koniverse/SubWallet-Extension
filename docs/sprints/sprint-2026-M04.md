...
in 2026-04 are locatable in time, as the frontmatter spec requires. Its `goal` is derived
...
See [EPIC-22](epics/EPIC-22.md) — the stories dated 2026-04 in the coverage index.
