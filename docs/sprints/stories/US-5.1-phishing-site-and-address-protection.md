...
| | |
| --- | --- |
| Upstream release | **0.35.1** (2020-11-30) — a **polkadot-js** release, not a SubWallet one |
...
This story used to carry `version_shipped: 0.35.1`, which was **actively misleading**: read
on SubWallet's version line, `0.35.1` sits *after* 0.8.1 — so the docs implied the capability
