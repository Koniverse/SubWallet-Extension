...
**1 tracker issue**, relocated here on 2026-07-22 from the Build & Platform ledger, where a title
heuristic had filed it under *Firefox* rather than under the capability it broke.

| Shipped | Issue | Title | Status |
|---|---|---|---|
| — | [#1938](https://github.com/Koniverse/SubWallet-Extension/issues/1938) | WebApp — camera not detected on Firefox | ✅ done |

> **Firefox is the condition, not the capability.** The report is *"Actual: do not detect camera"* —
