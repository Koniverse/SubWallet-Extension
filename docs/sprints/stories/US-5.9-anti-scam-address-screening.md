...
**2 tracker issues** make up this capability. Both are **open**, and both name the same integration two years apart — #1481 (2023) and #3410 (2024).

| Shipped | Issue | Title | Status |
|---|---|---|---|
| — | [#1481](https://github.com/Koniverse/SubWallet-Extension/issues/1481) | Integrate Merkle Science's original API for anti-scam addresses | 📋 backlog |
| — | [#3410](https://github.com/Koniverse/SubWallet-Extension/issues/3410) | Integrate Merkle Science API | 📋 backlog |
