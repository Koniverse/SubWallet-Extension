...
**None from the security ledger — but 7 candidates are waiting.** No issue in the former
...
> **This capability's history is not empty — it is not yet folded.** A title scan of the **13
> ledgers still separate** finds **7 issues** mentioning "reset wallet" / "forgot password", sitting in EPIC-26, EPIC-27, EPIC-30, EPIC-34, EPIC-41.
