...
goal: "Reconstructed window — 2 story/stories shipped in release 0.6.7 (EPIC-4, EPIC-9). Derived from the CHANGELOG, not planned."
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| US-4.11 | Custom token import (ERC-20 / PSP-22) | EPIC-4 | P1 | 3 | ✅ done | — | [link](stories/US-4.11-custom-token-import.md) |
| US-9.1 | Substrate NFT display (RMRK / Unique / PSP-34) | EPIC-9 | P1 | 5 | ✅ done | — | [link](stories/US-9.1-substrate-nft-display.md) |

**Releases in this window:** 0.6.7 · **Points (retroactive):** 8
