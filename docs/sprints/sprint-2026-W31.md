...
| US-4.21 | Asset Hub migration hardening | EPIC-4 | P1 | 3 | review | new | [link](stories/US-4.21-asset-hub-migration-hardening.md) |
| US-4.22 | RPC & endpoint-management hardening | EPIC-4 | P1 | 3 | review | new | [link](stories/US-4.22-rpc-and-endpoint-management-hardening.md) |
| US-4.23 | Bitcoin-API path hardening | EPIC-4 | P1 | 3 | review | new | [link](stories/US-4.23-bitcoin-api-path-hardening.md) |
| US-5.10 | Security audit & remediation hardening | EPIC-5 | P1 | 5 | in-progress | new | [link](stories/US-5.10-verichains-audit-remediation-hardening.md) |
...
| US-10.11 | WalletConnect session & dashboard hardening | EPIC-10 | P1 | 3 | in-progress | new | [link](stories/US-10.11-walletconnect-session-and-dashboard-hardening.md) |
| US-13.11 | XCM & bridge reliability hardening (runtime-upgrade & ParaSpell-version) | EPIC-13 | P2 | 5 | in-progress | new | [link](stories/US-13.11-xcm-runtime-upgrade-paraspell-version-hardening.md) |
...
| US-20.4 | Many-account submit performance | EPIC-20 | P1 | 5 | review | new | [link](stories/US-20.4-many-account-submit-performance.md) |

**19 stories · 91 points.** The active product-development sprint (weekly cadence, following W30). EPIC-4's network & RPC hardening cluster is the bulk; the remaining stories span onboarding/build (EPIC-1), dApp (EPIC-10), XCM (EPIC-13), governance (EPIC-15), hardware (EPIC-16), performance (EPIC-20), notifications (EPIC-19) and security (EPIC-5).
