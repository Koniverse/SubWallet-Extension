...
goal: "Reconstructed window — 1 story/stories shipped in release 1.1.11 (EPIC-19). Derived from the CHANGELOG, not planned."
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| US-19.2 | Multi-language i18n (VI/ZH/JA/RU) — Round 1 | EPIC-19 | P1 | 5 | ✅ done | — | [link](stories/US-19.2-multi-language-i18n-round-1.md) |

**Releases in this window:** 1.1.11 · **Points (retroactive):** 5
