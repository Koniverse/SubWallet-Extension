...
goal: "Reconstructed window — 1 story/stories shipped in release 1.3.75 (EPIC-8). Derived from the CHANGELOG, not planned."
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| US-8.6 | Subscan API-key configuration | EPIC-8 | P2 | 3 | ✅ done | — | [link](stories/US-8.6-subscan-api-key-configuration.md) |

**Releases in this window:** 1.3.75 · **Points (retroactive):** 3
