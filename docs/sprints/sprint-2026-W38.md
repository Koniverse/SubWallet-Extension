...
appeared, not at closeout — the first window where the table was told in time. **+2 · 13 on 09-17**
when US-42.25 was written for #5072 and US-42.26 opened as the v1.3.90 release gate, both taken by the tester the same day. Rows marked *tester*
