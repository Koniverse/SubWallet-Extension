...
goal: "Reconstructed window — 2 story/stories shipped in release 0.5.3 (EPIC-12). Derived from the CHANGELOG, not planned."
---
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| US-12.3 | Collator / parachain staking | EPIC-12 | P1 | 3 | ✅ done | — | [link](stories/US-12.3-collator-parachain-staking.md) |
| US-12.5 | dApp staking (Astar) | EPIC-12 | P2 | 5 | ✅ done | — | [link](stories/US-12.5-dapp-staking-astar.md) |

**Releases in this window:** 0.5.3 · **Points (retroactive):** 8
