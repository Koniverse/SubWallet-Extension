...
| — | [#1700](https://github.com/Koniverse/SubWallet-Extension/issues/1700) | WebApp — AirDrop Tracking | ✅ done | `US-41.150` | US-19.5 |
...
| — | [#1915](https://github.com/Koniverse/SubWallet-Extension/issues/1915) | Update web-runner for i18n for background | ✅ done | `US-41.174` | US-19.2 |
...
| — | [#2395](https://github.com/Koniverse/SubWallet-Extension/issues/2395) | WebApp — Update mission pool feature | ✅ done | `US-32.177` | US-19.7 |
...
| — | [#2710](https://github.com/Koniverse/SubWallet-Extension/issues/2710) | [Growth] Request to add Mission Pool to the Settings screen on Extension | ✅ done | `US-32.231` | US-19.7 |
...
| — | [#2996](https://github.com/Koniverse/SubWallet-Extension/issues/2996) | WebApp — Improve UI for Mission pools feature | ✅ done | `US-26.158` | US-19.7 |
...
| — | [#3342](https://github.com/Koniverse/SubWallet-Extension/issues/3342) | WebApp — Improve Mission pool feature | ✅ done | `US-32.290` | US-19.7 |
...
Most rows carry . That means **no CHANGELOG line and no tag proves a release**, not *unreleased*:
i18n and Mission Pools work ships inside whatever release its screen shipped in, and the WebApp,
mobile and Avail Space each have their own version space
([AGENTS.md](../../AGENTS.md) rule 1b). The eight rows that do carry a version are the ones the
CHANGELOG names.
